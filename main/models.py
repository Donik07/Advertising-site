...
class AdvUser(AbstractUser):
    ...
    send_messages = models.BooleanField(default=True, db_index=True, verbose_name='Уведомлять о новых комментариях?')
...
class Rubric(models.Model):
    name = models.CharField(max_length=20, db_index=True, unique=True, verbose_name='Наименование')
